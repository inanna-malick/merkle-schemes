...
mkDerivation {
  ...
  libraryHaskellDepends = [
    aeson base base16-bytestring base64-bytestring bifunctors
    bytestring containers deriving-compat directory free memory mtl
    pretty random safe-exceptions singletons text transformers
